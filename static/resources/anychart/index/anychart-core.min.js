...
c=a?this.RI():"",$.we(this.g,{href:a?this.TI():"https://www.anychart.com/?utm_source=trial",title:c.replace("{{anychart-version}}",b),target:"_blank"}),$.we(this.b,{alt:a?this.SI():"AnyChart - JavaScript Charts"}),this.I($k));this.J(al)&&(a=a?this.text():"",$.Ze(this.D,a),this.I(al));if(this.J(bl)){if(a=fl(this)?this.CE():dl()){if(this.O=a,b=rh($.ig()))$.Ed(b,"complete",this.R1,!1,this),$.Ed(b,
